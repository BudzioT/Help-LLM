...
def get_response(prompt):
    """Generate response from basic GPT"""
    ##############################################
    # Setup model
    ##############################################
    ...
    # Get response
    token_ids = generate(gpt, device, text_to_ids(prompt, tokenizer),
...
def main():
    ...
    # Generate text
    ##############################################
    # Example: Feeling worthless, Private life is, Maintaining motivation, Feeling lonely
    iface = gr.Interface(fn=get_response, inputs="text", outputs="text", title="Hera Model")
    iface.launch()
